...
Creator=["YOUR MID"]
Owner=["YOUR MID"]
RfuSekawan = RfuBot + Rfu + Creator + Owner
...
Squad = {
    ...
    "AddMention":True,
    "Admin": {
        "YOUR MID":True,  #TARO MID ADMIN NYA DISINI
        "YOUR MID":True
    },
    "Owner": {
        "YOUR MID":True,  #TARO MID OWNER NYA DISINI
        "YOUR MID":True
    },
}
...
def RIDEN_FAST_USER(fast):
    try:
                              ...
                              try:
                                  ...
                                  try:
                                      ...
                                      try:
                                          ...
                                          Riden = riden6.reissueGroupTicket(fast.param1)
                              ...
                              try:
                                  ...
                                  try:
                                      ...
                                      try:
                                          ...
                                          Riden = riden4.reissueGroupTicket(fast.param1)
                                          riden4.kickoutFromGroup(fast.param1,[fast.param2])
                                          Squad["Blacklist"][fast.param2] = True
                                      except:
                                          pass
        ...
        if fast.type == 13:
          if fast.param3 in Squad["Blacklist"]:
            if fast.param2 not in RfuSekawan and fast.param2 not in Owner and fast.param2 not in Squad["Admin"] and fast.param2 not in Squad["Owner"]:
...
#---------------------------------- SCRIP PROTECT GRUP -------------------------------------#
        ...
        if fast.type == 19:
            if fast.param3 in Squad["Owner"]:        # JIKA Owner2 KE KICK
              if fast.param2 not in RfuSekawan and fast.param2 not in Owner and fast.param2 not in Squad["Admin"] and fast.param2 not in Squad["Owner"]:
                  random.choice(Rfu).kickoutFromGroup(fast.param1,[fast.param2])
                  riden1.findAndAddContactsByMid(fast.param3)
                  riden1.inviteIntoGroup(fast.param1,[fast.param3])
